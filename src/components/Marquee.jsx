import { Icon } from "@iconify/react/dist/iconify.js"; // Icon component for displaying icons
import gsap from "gsap"; // GSAP animation library
import { Observer } from "gsap/all"; // GSAP Observer plugin for scroll/gesture detection
...
const Marquee = ({
  ...
  const containerRef = useRef(null); // Ref for marquee container
  const itemsRef = useRef([]); // Refs for each marquee item

  // Custom GSAP horizontal loop animation for marquee effect
  ...
  // Set up marquee animation and scroll/gesture observer
  useEffect(() => {
